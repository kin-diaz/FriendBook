...
// Upload page for users to upload a new photo, crop the photo and get a new profile picture.
// Taken from an online source and used because it works really well.
...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/FriendBook/assets/images/profile_pics';
	//Set File name	
...
<div class="upload-page">
	<h3>Upload Page</h3>
	<p class="info">Choose a new profile picture</p>
	<div id="formExample">
	    <p><b> <?=$msg?> </b></p>
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
			<div class="new">
				<label class="file">
					...
					<span class="file-custom">Choose a File To Upload</span>
				</label>
...
<footer style="font-size: 12px;"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><p style="margin-left: 170px">Copyright ©️ 2021 Bath Spa University | All Rights Reserved</p></footer>
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: 170px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
