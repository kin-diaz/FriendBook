...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="assets/stylesheets/style-2.css">
</head>
<body>
<!-- Loads the comments for every post as an iframe. -->
	<?php  
	...
	<?php  
		...
		if(isset($_POST['postComment' . $post_id])) {
			...
			echo "<p style='margin-bottom: 10px;'>Comment Posted! </p>";
		}
		?>
		...
		if($count != 0) {
			...
			while($comment = mysqli_fetch_array($get_comments)) {
				...
				<div class="comment_section">
					...
					<div>
						<div class="text">
							<a href="<?php echo $posted_by?>" target="_parent" class="text"> 
